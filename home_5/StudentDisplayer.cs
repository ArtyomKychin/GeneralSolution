    ...
    public class StudentDisplayer
    {
        public void DysplayGroupe1(Student[] arrayOfGroup1)
        {
            foreach (Student groupe1 in arrayOfGroup1)
            {
                ...
                Console.WriteLine($"MathMark: {groupe1.MathMark}, PhysicalEducationMark: {groupe1.PhysicalEducationlMark}, biologyMark: {groupe1.BiologyMark}");
            }
        ...
        public void DysplayGroup2(Student[] arrayOfGroup2)
        {
            foreach (Student groupe2 in arrayOfGroup2)
            {
                ...
                Console.WriteLine($"MathMark: {groupe2.MathMark}, PhysicalEducationMark: {groupe2.PhysicalEducationlMark}, biologyMark: {groupe2.BiologyMark}");
            }
        ...
        public void DysplayGroup3(Student[] arrayOfGroup3)
        {
            foreach (Student groupe3 in arrayOfGroup3)
            {
                ...
                Console.WriteLine($"MathMark: {groupe3.MathMark}, PhysicalEducationMark: {groupe3.PhysicalEducationlMark}, biologyMark: {groupe3.BiologyMark}");
            }
